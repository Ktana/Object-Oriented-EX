...
public class Algo_2 {
	...
	public static   Full_Coordinate algorithm_2(String mac1, int signal1, String mac2, int signal2, String mac3, int signal3) {
		//////////////////////////////////////////////////////////////////
		Full_Coordinate[]C1 = new Full_Coordinate[10];
		int index = 0;
		int[]s1 = new int[10];
		...
		Arrays.sort(s1);
		//////////////////////////////////////////////////////////////////
		Full_Coordinate[]C2 = new Full_Coordinate[10];
		int[]s2 = new int[10];
		index=0;
		...
		Arrays.sort(s2);		
		//////////////////////////////////////////////////////////////////
		Full_Coordinate[]C3 = new Full_Coordinate[10];
		int[]s3 = new int[10];
		index=0;
		...
		Full_Coordinate coo1 = algorithm_1(mac1);
		Full_Coordinate coo2 = algorithm_1(mac2);
		Full_Coordinate coo3 = algorithm_1(mac3);
	...
	private static Full_Coordinate algorithm_1(String mac1) {
		return null;
	}
	...
	private static   int close_signal(int signal, int[]a) {
		...
		int tempA = Math.abs(a[i]) - Math.abs(signal);
		int tempB=0;
		if(a[i+1]!= 0) {
