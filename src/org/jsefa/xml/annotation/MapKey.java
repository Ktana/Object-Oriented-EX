...
public @interface MapKey {
    ...
    /**
     * The name of the data type this <code>MapKey</code> describes. If not set, it must be determinable from
    ...
    /**
     * The type of the object this <code>MapKey</code> describes. From this the data type must be determinable
    ...
    /**
     * Specifies the converter type to be used for the xml attribute which must have a simple data type (no children,
     * no data holding attributes). In the default case the converter type is determined using the type of the map
     * key.
     */
